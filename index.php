...
<meta charset="utf-8">
	...
	<title>Jennifer Thomas - STIM 3320 - Session 15 LAB</title>
...
<script>
	function promptQuantity()  {
	  var quantity;
	  quantity = prompt("Please enter a number greater than 15");
	  if (quantity <= 15)    {
		 alert("Quantity is not greater than 15.");
	  } else {
		 alert("Thank you for entering a quantity greater than 15.");
	  } // end if
   ...
   <body>
	...
	<div>
		  <hr/>
		  <h1>Using JavaScript - Lab Session 15 </h1>
		  <button onclick="promptQuantity();">Click to enter a number</button>
		 		  </p>
